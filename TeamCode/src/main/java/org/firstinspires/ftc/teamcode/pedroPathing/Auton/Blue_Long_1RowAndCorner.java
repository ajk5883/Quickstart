...
/**
 * Blue alliance – Long side auton: 1 row pickup + 1 corner cycle, then park.
 *
 ...
 */
@Autonomous(name = "Blue L 1R", group = "BlueAuton")
public class Blue_Long_1RowAndCorner extends AutonBase {
    ...
    protected AutonConfig getConfig() {
        ...
        return AutonConfig.withDefaults(startPose, follower -> {
            ...
            // ── Row pickup sweep ──────────────────────────────────────────────
            // Approach: maintain row-heading throughout so intake aligns early
            ...
            // Sweep: tangent so robot faces travel direction
