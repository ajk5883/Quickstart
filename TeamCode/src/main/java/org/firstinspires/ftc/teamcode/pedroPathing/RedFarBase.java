...
public class RedFarBase extends OpMode {
    ...
    private boolean pathDelayElapsed() {
        return pathTimer.getElapsedTimeMilliseconds() >= PATH_DELAY_MILLISECONDS;
    }
...
public void buildPaths() {
    ...
    switch (pathState) {
        ...
        case 2:
            if(pathDelayElapsed()) {
                followPathAfterDelay(grabPickup1, 3);
            }
            break;
        case 3:
            if(!follower.isBusy()) {
        ...
        case 4:
            if(pathDelayElapsed()) {
                followPathAfterDelay(scorePickup1, 5);
            }
            break;
        case 5:
            if(!follower.isBusy()) {
        ...
        case 6:
            if(pathDelayElapsed()) {
                followPathAfterDelay(grabPickup2, 7);
            }
            break;
        case 7:
            if(!follower.isBusy()) {
        ...
        case 8:
            if(pathDelayElapsed()) {
                followPathAfterDelay(scorePickup2, 9);
            }
            break;
        case 9:
            if(!follower.isBusy()) {
        ...
        case 10:
            if(pathDelayElapsed()) {
                followPathAfterDelay(grabPickup3, 11);
            }
            break;
        case 11:
            if(!follower.isBusy()) {
        ...
        case 12:
            if(pathDelayElapsed()) {
                followPathAfterDelay(scorePickup3, 13);
            }
            break;
        case 13:
            if(!follower.isBusy()) {
